      ...
      >
            ...
            <div className="flex flex-col items-center justify-start min-h-screen mt-20">
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    ...
                    <p className="mt-4">
                    This website is operated by Pitstop Paradise. Throughout the site, the terms "we," "us," and "our" refer to Pitstop Paradise. Pitstop Paradise offers this website, including all information, tools, and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here.
                    ...
                    Our store is hosted on Wix Studio, which provides us with the online e-commerce platform that allows us to sell our products and services to you.
                    </p>
                </div>
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">SECTION 2 - GENERAL CONDITIONS</h1>
                    <p className="mt-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">​SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h1>
                    <p className="mt-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">​​​SECTION 7 - OPTIONAL TOOLS</h1>
                    <p className="mt-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">​​SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h1>
                    <p className="mt-4">
                    ...
                    a false email address, pretend to be someone other than yourself, or otherwise mislead us or third parties as to the origin of any comments. You are solely responsible for any comments you make and their accuracy. We take no responsibility and assume no liability for any comments posted by you or any third party.
                    </p>
                </div>
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h1>
                    <p className="mt-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h1>
                    <p className="mt-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">​SECTION 15 - SEVERABILITY</h1>
                    <p className="mt-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">​SECTION 17 - ENTIRE AGREEMENT</h1>
                    <p className="mt-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-3xl">
                    <h1 className="text-4xl font-bold">SECTION 19 - CHANGES TO TERMS OF SERVICE</h1>
                    <p className="mt-4">
